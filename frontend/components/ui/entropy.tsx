...
export function Entropy({ className = "", size = 460 }: EntropyProps) {
    ...
    class Particle {
      ...
      update() {
        if (this.order) {
          ...
          this.x +=
            dx * 0.05 * (1 - this.influence) + chaosInfluence.x * this.influence;
          this.y +=
            dy * 0.05 * (1 - this.influence) + chaosInfluence.y * this.influence;
